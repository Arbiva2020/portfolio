...
const Sidenav = ()=> {
    ...
    return (
        <div>
            <AiOutlineMenu onClick={handleNav} className="absolute top-4 right-4 z-[99] md:hidden text-gray-400"/>
            {
                nav ? (
                    <div className="fixed w-full h-screen bg-gray/90 flex flex-col justify-center items-center z-20">
